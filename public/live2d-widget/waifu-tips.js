...
function initWidget(waifuPath, apiPath) {
	...
	$("#waifu-tool .fa-archive").click(function() {
		location.href = "/archive";
	});
	$("#waifu-tool .fa-tags").click(function() {
		location.href = "/tags";
	});
	$("#waifu-tool .fa-comments-o").click(function() {
		location.href = "/comments";
	});
	$("#waifu-tool .fa-quote-left").click(function() {
		showHitokoto();
	});
	$("#waifu-tool .fa-magic").click(function() {
		loadRandModel();
	});
	$("#waifu-tool .fa-cube").click(function() {
		loadOtherModel();
	});
	...
	var getActed = false,
		hitokotoTimer = null,
		messageTimer = null,
		messageArray = ["已经过了这么久了呀，日子过得好快呢……", "嗨～快来逗我玩吧！"],
		apiURL = "";
