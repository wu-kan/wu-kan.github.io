...
```mermaid
graph LR
A--链路link，专用介质dedicated medium---B,节点node或主机host
```
...
1.处理延迟（processing）
  ...
  * 检查比特错
  * 确定输出链路2.排队延迟（queueing）


  * 在输出链路队列等待发送
  * 依赖于路由器的拥塞程度3.传输延迟（transmission delay）


  * 包长（bits）/链路带宽（bps），也称为发送延迟4.传播延迟（propagation delay）
...
![](https://img-blog.csdn.net/20180612151953794?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L04xbmVEaW5n/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
![](https://img-blog.csdn.net/2018061215273169?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L04xbmVEaW5n/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
![](https://img-blog.csdn.net/20180612154642373?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L04xbmVEaW5n/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
![](https://img-blog.csdn.net/20180612155409759?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L04xbmVEaW5n/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
