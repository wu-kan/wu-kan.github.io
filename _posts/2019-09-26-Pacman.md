...
def uniformCostSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    def cost(path): return problem.getCostOfActions([x[1] for x in path])
...
def breadthFirstSearch(problem):
    ...
    "*** YOUR CODE HERE ***"
    return frontierSearch(problem, util.PriorityQueueWithFunction(len))
    # util.raiseNotDefined()
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    "*** YOUR CODE HERE ***"
    def cost(path): return problem.getCostOfActions(
        [x[1] for x in path]) + heuristic(path[len(path)-1][0], problem)
    return frontierSearch(problem, util.PriorityQueueWithFunction(cost))
    # util.raiseNotDefined()
