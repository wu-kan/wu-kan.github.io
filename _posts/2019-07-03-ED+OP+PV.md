...
{% for img in page.ED %}{{img.value}}![ED({{img.key}})](https://wu-kan.cn/MizunoAi/ED/ED({{img.key}}).jpg){% endfor %}

## OP

{% for img in page.OP %}{{img.value}}![OP({{img.key}}](https://wu-kan.cn/MizunoAi/OP/OP({{img.key}}).jpg){% endfor %}

## PV

{% for img in page.PV %}{{img.value}}![PV({{img.key}})](https://wu-kan.cn/MizunoAi/PV/PV({{img.key}}).jpg){% endfor %}
