...
客户端：
![](/public/image/2019-03-11-2.png)
服务器：
![](/public/image/2019-03-11-3.png)
### 服务器的全部源代码（或自选主要代码）
```c
#include <stdio.h>
#include <time.h>
...
### 只运行客户端程序而不运行服务器程序会出现什么错误，截屏并说明原因
![](/public/image/2019-03-11-4.png)
如图，在发送时没有报错，但是试图从服务器获得信息时获得了10054的报错。
### 截屏服务器和客户端的运行结果（注明客户端和服务器）
![](/public/image/2019-03-11-5.png)
服务器：
![](/public/image/2019-03-11-6.png)
### 服务器的全部源代码（或自选主要代码）
```c
#include <stdio.h>
#include <string.h>
