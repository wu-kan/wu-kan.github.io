...
#### 显示Router1的路由表并截屏
![](/public/image/2019-05-05-1.png)
#### 显示Router2的路由表并截屏
![](/public/image/2019-05-05-2.png)
#### PC1依次ping 到PC2路经上的所有IP地址，并截屏
![](/public/image/2019-05-05-3.png)
...
#### 显示Router1的路由表并截屏
![](/public/image/2019-05-05-4.png)
#### 显示Router2的路由表并截屏
![](/public/image/2019-05-05-5.png)
#### PC1 ping PC2 并截屏
![](/public/image/2019-05-05-6.png)
#### 分析Router1路由表和Router2路由表的路由组成
...
#### PC1依次ping 到PC2路经上的所有IP地址，并截屏
![](/public/image/2019-05-05-7.png)
#### PC2依次ping 到PC1路经上的所有IP地址，并截屏
![](/puclic/image/2019-05-05-8.png)
#### 分析结果
...
#### PC1 ping PC2，并截屏
![](/public/image/2019-05-05-9.png)
#### 显示Router1的路由表并截屏
![](/public/image/2019-05-05-10.png)
#### 分析结果
...
![](/public/image/2019-05-05-11.png)
...
#### 用PC1 ping PC2并截屏
![](/public/image/2019-05-05-12.png)
...
#### 显示Router1的路由表并截屏
![](/public/image/2019-05-05-13.png)
#### 显示Router2的路由表并截屏
![](/publuc/image/2019-05-05-14.png)
