...
{% for img in page.ED %}{{img.value}}![ED({{img.key}})](https://github.com/wu-kan/MizunoAi/raw/master/ED/ED({{img.key}}).jpg){% endfor %}

## OP

{% for img in page.OP %}{{img.value}}![OP({{img.key}}](https://github.com/wu-kan/MizunoAi/raw/master/OP/OP({{img.key}}).jpg){% endfor %}

## PV

{% for img in page.PV %}{{img.value}}![PV({{img.key}})](https://github.com/wu-kan/MizunoAi/raw/master/PV/PV({{img.key}}).jpg){% endfor %}
